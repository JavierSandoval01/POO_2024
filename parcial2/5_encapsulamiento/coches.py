...
class Coches:
    ...
    def __init__(self,color,marca,modelo,velocidad,caballaje,plazas):
        ...
        #El encapsulamiento en python tambien es llamado visibilidad y practicamente se puede que un atributo y/o metodo sean publicos o privados
        
#Atributo publico
    atributo_publico="Soy un atributo publico"

#Soy un atributo privado, con dos guiones bajo al principio

    __atributo_privado="Soy un atributo privado"

#Nota1 para utilizar un atributo privado es necesario acerlo a travez de un metodo publico
...
#Nota2  para utilizar un metodo privado es necesario hacer lo dentro de un metodo publico
